...
-- Allow public insert to tenders
DROP POLICY IF EXISTS public_insert_tenders ON tenders;
CREATE POLICY public_insert_tenders ON tenders
    FOR INSERT WITH CHECK (true);
...
-- Allow public insert to contract_awards
DROP POLICY IF EXISTS public_insert_contract_awards ON contract_awards;
CREATE POLICY public_insert_contract_awards ON contract_awards
    FOR INSERT WITH CHECK (true);
