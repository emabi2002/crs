          ...
          <CardContent className="py-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Create new records in the system</p>
              </div>
              <div className="flex flex-wrap items-center gap-2">
                <Link href="/tenders/new">
                  <Button size="sm" variant="outline" className="gap-2 bg-background hover:bg-primary hover:text-primary-foreground">
